# -*- coding: utf-8 -*-
#
# dnf-plugins-extras documentation build configuration file, created by
...
project = u'dnf-plugins-extras'
copyright = u'2014, Igor Gnatenko, Licensed under GPLv2+'
...
htmlhelp_basename = 'dnf-plugins-extrasdoc'
...
latex_documents = [
  ('index', 'dnf-plugins-extras.tex', u'dnf-plugins-extras Documentation',
...
AUTHORS=[u'See AUTHORS in your Extras DNF Plugins distribution']
...
texinfo_documents = [
  ('index', 'dnf-plugins-extras', u'dnf-plugins-extras Documentation',
   AUTHORS[0], 'dnf-plugins-extras', 'One line description of project.',
   'Miscellaneous'),
]
